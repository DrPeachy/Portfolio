...
const IndexNumber = styled.div`
  ...
  @media (max-width: 960px) {
    left: -1rem !important; /* 手机上不要偏出去太多，防止出现横向滚动条 */
    right: auto !important;
  }
`;
            ...
            <ProjectRow $reversed={isReversed}>
              ...
              <InfoColumn $reversed={isReversed}>
                <div style={{ position: "relative" }}>
                  <IndexNumber $reversed={isReversed}>
                    {String(index + 1).padStart(2, "0")}
                  </IndexNumber>
                  <ProjectDate $reversed={isReversed}>
                    {t(`showcase.showcaseData.${project.localizationKey}.date`)}
                  </ProjectDate>
                  <ProjectTitle>
                    {t(
                      `showcase.showcaseData.${project.localizationKey}.title`,
                    )}
                  </ProjectTitle>
                </div>
                ...
                <ProjectDesc>
                  ...
                  {t(
                    `showcase.showcaseData.${project.localizationKey}.description`,
                  ) ||
                    "A detailed exploration of graphics programming techniques and visual fidelity."}
                </ProjectDesc>
